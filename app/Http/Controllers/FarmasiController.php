...
WHEN dd.NAMA_TARIF LIKE '%creatinin%' THEN bb.kode_layanan_header #CONCAT(aa.no_sep,'-',bb.kode_layanan_header,'-PGCT')
            WHEN dd.nama_tarif NOT IN ('[PRD] - CMV PCR Kualitatif'
            ,'Apus Vagina'
,'Gall Kultur Darah (Resin)'
                                                            ,'Gall Kultur Urine(Urotube)'
                                                            ,'Identifikasi Parasit'
                                                            ,'Kultur'
                                                            ,'KULTUR / IDENTIFIKASI KUMAN'
...
WHEN dd.nama_tarif NOT IN ('[PRD] - CMV PCR Kualitatif','Apus Vagina','Gall Kultur Darah (Resin)'
                                                            ,'Gall Kultur Urine(Urotube)'
                                                            ,'Identifikasi Parasit'
                                                            ,'Kultur'
                                                            ,'KULTUR / IDENTIFIKASI KUMAN'
                                                            ...
                                                            ,'Swab SARS-CoV-2 [ii PCR]'
                                                            ,'Swab SARS-CoV-2 [RT PCR]'
                                                      ) THEN CONCAT('http://192.168.2.74/smartlab_waled/his/his_report?hisno=',bb.kode_layanan_header)
