...
Route::post('lihathasilpenunjang_lab_dokter', [ErmController::class, 'lihathasilpenunjang_lab'])
    ->name('lihathasilpenunjang_lab_dokter'); //sidebar
...
Route::group(['middleware' => ['auth', 'hak_akses1:4']], function () {
    ...
    Route::post('/simpanposthd', [ErmController::class, 'simpanposthd'])
        ->name('simpanposthd'); //sidebar
    Route::post('/simpanpenyulithd', [ErmController::class, 'simpanpenyulithd'])
        ->name('simpanpenyulithd'); //sidebar
    Route::post('/simpanevaluasi', [ErmController::class, 'simpanevaluasi'])
...
Route::post('/formpembuatansuratpengantar', [ErmController::class, 'formpembuatansuratpengantar'])->name('formpembuatansuratpengantar'); //formpasien_bpjs
...
Route::get('/cetakcatatanhemodialisa/{id}', [PdfController::class, 'cetakcatatanhemodialisa']); //formpasien_bpjs
...
Route::get('indexriwayatpemeriksaanlab_pa', [BillingController::class, 'indexriwayatpemeriksaanlab_pa'])->name('indexriwayatpemeriksaanlab_pa');
...
Route::post('cari_riwayat_hasil_pemeriksaan_pa', [BillingController::class, 'cari_riwayat_hasil_pemeriksaan_pa'])->name('cari_riwayat_hasil_pemeriksaan_pa');
...
Route::post('cari_laporan_pendapatan_lab_pa', [BillingController::class, 'cari_laporan_pendapatan_lab_pa'])->name('cari_laporan_pendapatan_lab_pa');
...
Route::post('ambildataklaimfarmasi', [newFarmasiController::class, 'ambildataklaimfarmasi'])->name('ambildataklaimfarmasi');
