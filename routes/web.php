...
Route::get('suratkejiwaan_index', [McuController::class, 'suratkejiwaan_index'])->middleware('auth')->name('suratkejiwaan_index');
Route::get('suratnapsa_index', [McuController::class, 'suratnapsa_index'])->middleware('auth')->name('suratnapsa_index');
...
Route::post('ambildatasurat', [McuController::class, 'ambildatasurat'])->middleware('auth')->name('ambildatasurat');
Route::post('ambildatasuratnapsa', [McuController::class, 'ambildatasuratnapsa'])->middleware('auth')->name('ambildatasuratnapsa');
...
Route::get('cetak_rohani/{id}', [McuController::class, 'cetak_rohani'])->name('cetak_rohani');
