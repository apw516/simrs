                                            ...
                                            <div class="card-header p-2">
                                                <ul class="nav nav-pills">
                                                    <li class="nav-item"><a class="nav-link active"
                                                            href="#activity{{ $ct->id }}" data-toggle="tab"><i
                                                                class="bi bi-bookmark-plus mr-1 ml-1"></i>Assemen awal
                                                            medis</a></li>
                                                    <li class="nav-item"><a class="nav-link"
                                                            href="#timeline{{ $ct->id }}" data-toggle="tab"><i
                                                                class="bi bi-bookmark-plus mr-1 ml-1"></i>Assesmen awal
                                                            keperawatan</a></li>
                                                </ul>
                                            </div><!-- /.card-header -->
                                            <div class="card-body">
                                                <button idheader="{{ $ct->idasskep}}" class="btn btn-warning mb-3 caricppt" data-toggle="modal"
                                                    data-target="#modalcppt"><i
                                                        class="bi bi-journal-plus mr-1 ml-1"></i> Lihat CPPT</button>
                                                        ...
                                                        <table class="table table-sm table-bordered">
                                                            ...
                                                            <tr class="bg-light text-bold">
                                                                <td>Tanggal dan jam kunjungan :
                                                                    {{ $ct->tanggalkunjungan }} </td>
                                                                <td>Tanggal dan jam pemeriksaan :
                                                                    {{ $ct->tanggalperiksa }} </td>
                                                            </tr>
                                                            @if ($ct->kode_unit == '1028')
                                                                <tr class="font-italic text-bold">
                                                                    <td colspan="2">Tekanan Darah :
                                                                        {{ $ct->tekanan_darah }}
                                                                    </td>
                                                                </tr>
                                                                <tr class="font-italic text-bold">
                                                                    <td colspan="2">Frekuensi Nadi :
                                                                        {{ $ct->frekuensi_nadi }}
                                                                    </td>
                                                                </tr>
                                                                <tr class="font-italic text-bold">
                                                                    <td colspan="2">Frekuensi Nafas :
                                                                        {{ $ct->frekuensi_nafas }}
                                                                    </td>
                                                                </tr>
                                                                <tr class="font-italic text-bold">
                                                                    <td colspan="2">Suhu : {{ $ct->suhu_tubuh }}
                                                                    </td>
                                                                </tr>
                                                                <tr class="font-italic text-bold">
                                                                    <td colspan="2">Berat Badan :
                                                                        {{ $ct->beratbadan }} </td>
                                                                </tr>
                                                                <tr class="font-italic text-bold">
                                                                ...
                                                                <tr class="font-italic text-bold">
                                                                    <td colspan="2">Anamnesa : {{ $ct->anamnesa }}
                                                                    </td>
                                                                </tr>
                                                                <tr class="font-italic text-bold">
                                                                ...
                                                                <tr class="font-italic text-bold">
                                                                    <td colspan="2">Anjuran : {{ $ct->anjuran }}
                                                                    </td>
                                                                </tr>
                                                                <tr class="font-italic text-bold">
                                                                    <td colspan="2">Evaluasi : {{ $ct->evaluasi }}
                                                                    </td>
                                                                </tr>
                                                                <tr class="font-italic text-bold">
                                                            ...
                                                            @elseif($ct->kode_unit == '1026')
                                                                ...
                                                                <tr class="font-italic text-bold">
                                                                    <td colspan="2">Diagnosa WD :
                                                                        {{ $ct->diagnosakerja }} </td>
                                                                </tr>
                                                                <tr class="font-italic text-bold">
                                                                    <td colspan="2">Dasar Diagnosa :
                                                                        {{ $ct->diagnosabanding }}
                                                                    </td>
                                                                </tr>
                                                                <tr class="font-italic text-bold">
                                                                ...
                                                                <tr class="font-italic text-bold">
                                                                    <td colspan="2">PENILAIAN EVALUASI JALAN
                                                                        NAFAS<br>
                                                                        @php
                                                            ...
                                                            @else
                                                                ...
                                                                @if ($ct->kode_unit == '1014')
                                                                    <tr class="font-italic text-bold">
                                                                        <td colspan="2">Hasil Pemeriksaan RO : <br>
                                                                            Hasil Pemeriksaan :
                                                                            {{ $ct->tajampenglihatandekat }}
                                                                            <br>
                                                                            MATA KIRI | MATA KANAN <br>
                                                                            Tekanan Intra Okular :
                                                                            {{ $ct->tekananintraokular }}
                                                                            <br>
                                                                ...
                                                                @endif
                                                                <tr class="font-italic text-bold">
                                                                    <td colspan="2">Diagnosis ( A ) :
                                                                        {{ $ct->diagnosakerja }} | Diagnosis Sekunder :
                                                                        {{ $ct->diagnosabanding }}<br><br>
            ...
            <div class="tab-pane" id="timeline{{ $ct->id }}">
                ...
                @else
                    <table class="table table-sm table-bordered">
                        ...
                        <tr>
                            <td colspan="2" class="text-center bg-light text-bold">Tanda
                                - Tanda Vital
                            </td>
                        </tr>
                        <tr class="font-italic text-bold">
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="card formanak">
                                        <div class="card-header text-bold bg-light">
                                            Metode
                                            FLACC
                                        ...
                                        <div class="card-body">
                                            <table class="table table-sm table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <tr class="font-italic text-bold table-primary">
                                                        <td>Face (Wajah)</td>
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="face" id="face" value="0"
                                                    ...
                                                    <tr class="font-italic text-bold table-primary">
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="Activity" id="Activity" value="0"
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="Activity" id="Activity" value="1"
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="Activity" id="Activity" value="2"
                                                    ...
                                                    <tr class="font-italic text-bold table-primary">
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="consolabity" id="consolabity"
                                                                    value="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="ekspresiwajah" id="ekspresiwajah"
                                                                    value="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="Menangis" id="Menangis" value="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="Menangis" id="Menangis" value="1"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="Menangis" id="Menangis" value="2"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="keadaanterangsang" id="keadaanterangsang"
                                                                    value="0"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @foreach ($mt_resiko as $mr)
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="resikojatuh" id="resikojatuh"
                                                                    value=""
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="table-primary">
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="diagnosis" id="diagnosis" value="0"
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="diagnosis" id="diagnosis" value="4"
                                                                    @if ($ct->diagnosis == 0) checked @endif>
                                                                <label class="form-check-label" for="exampleRadios1">
                                                                    Gangguan
                                                                    Neurologis
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="diagnosis" id="diagnosis" value="3"
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="diagnosis" id="diagnosis" value="2"
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="diagnosis" id="diagnosis" value="1"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="gangguankognitif" id="gangguankognitif"
                                                                    value="0"
                                                    ...
                                                    <tr class="table-primary">
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="faktorlingkungan" id="faktorlingkungan"
                                                                    value="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="responthdop" id="responthdop"
                                                                    value="0"
                                                    ...
                                                    <tr class="table-primary">
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="penggunaanobat" id="penggunaanobat"
                                                                    value="0"
                                                    ...
                                                    <tr class="table-primary">
                                                        <td colspan="4">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="tingkatresiko" id="tingkatresiko"
                                                                    value="0" checked>
                                                                <label class="form-check-label" for="exampleRadios2">
                                                                    -
                                                                </label>
                                            ...
                                            <table class="table table-sm table-bordered">
                                                    ...
                                                    <td>
                                                        @foreach ($mt_skala_penurunan_bb as $MS)
                                                            <div class="form-check ml-5">
                                                                <input class="form-check-input" type="radio"
                                                                    name="skalapenurunanbb" id="skalapenurunanbb"
                                                                    value=""
                                                    ...
                                                    <td>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                id="asupanmakananberkurang" value="1"
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                name="asupanmakananberkurang"
                                                                id="asupanmakananberkurang" value="2"
                                                    ...
                                                    <td colspan="2">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                id="pasiendengandiagnosakhusus" value="1"
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                name="pasiendengandiagnosakhusus"
                                                                id="pasiendengandiagnosakhusus" value="2"
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                name="resikomalnutrisi" id="resikomalnutrisi"
                                                                value="2"
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    id="apakahpasientampakkurus" value="1"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="apakahpasientampakkurus"
                                                                    id="apakahpasientampakkurus" value="0"
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    id="apakahadapenurunanbb" value="1"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="apakahadapenurunanbb"
                                                                    id="apakahadapenurunanbb" value="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="apakahadadiare" id="apakahadadiare"
                                                                    value="1"
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    id="resikomalnutrisianak" value="1"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="resikomalnutrisianak"
                                                                    id="resikomalnutrisianak" value="0"
...
<script>
      $(".caricppt").click(function(){
        ...
        $.ajax({
            ...
            url: '<?= route('ambilcppt2') ?>',
            success: function(response) {
                $('.v_cppt2').html(response);
                spinner.hide()
            }
        });
    })
