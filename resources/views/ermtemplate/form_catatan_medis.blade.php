                            ...
                            <div class="card">
                                ...
                                <div class="container">
                                    <table class="table table-sm text-sm">
                                        ...
                                        <tr>
                                            <td colspan="4" class="bg-warning text-bold">Status Fungsional</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="4" class="bg-warning text-bold">Assesmen Nyeri</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="4" class="text-bold bg-warning">Assesmen resiko jatuh</td>
                                        </tr>
                                        <tr>
                                            <td>Resiko Jatuh</td>
                                            <td>{{ $k->resikojatuh }}</td>
                                        ...
                                        <tr>
                                            <td colspan="4" class="text-bold bg-warning">Skrinning Gizi</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table class="table table-sm table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ $k->signature_perawat }}" alt=""><br>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-sm text-sm">
                                        ...
                                        <tr>
                                            <td colspan="4" class="text-bold bg-danger">Riwayat Kesehatan</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="4" class="text-bold bg-danger">Riwayat Penyakit Dahulu</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="4" class="text-bold bg-danger">Pemeriksaan Umum</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table class="table table-sm table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ $k->signature_dokter }}" alt=""><br>
