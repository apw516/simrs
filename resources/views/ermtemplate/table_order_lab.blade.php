<table id="table_order_lab" class="table table-sm table-bordered text-xs">
    <thead>
        <th>Kode Header</th>
        <th>Kode Detail</th>
        <th>Nama Layanan</th>
    ...
    <tbody>
        @foreach ($riwayat_tindakan_lab as $r)
...
<script>
    ...
    $('#table_order_lab').on('click', '.returheader', function() {
