        ...
        <div class="card-header bg-danger" id="headingOne">
            <h2 class="mb-0">
                <button class="btn btn-block text-light text-left" type="button" data-toggle="collapse"
                    data-target="#collapseOne_far" aria-expanded="true" aria-controls="collapseOne">
                    <i class="bi bi-ticket-detailed mr-1 ml-1"></i> ORDER FARMASI
                </button>
            </h2>
        </div>
        {{-- kodekunjungan --}}
        <div id="collapseOne_far" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <button type="button" class="btn btn-secondary riwayatreseppasien" norm="{{ $rm }}"
                    ...
                    <button type="button" class="btn btn-secondary float-right templateresepdokter" data-toggle="modal"
                        ...
                        Dokter</button>
                    <button type="button" class="btn btn-secondary float-right templateracikandokter"
                        data-toggle="modal" data-target="#modaltemplateracikandokter"><i class="bi bi-plus"></i>Template
                        Racikan
                        Dokter</button>
                </div><br><br>
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-footer">
                        <div class="form-group form-check">
                            <input type="checkbox" class="form-check-input" id="simpantemplatefar" name="simpantemplatefar"
                                value="1">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="namatemplatefar" id="namatemplatefar">
                        </div>
                    </div>
                </div>
            </div>
...
<input hidden type="text" value="{{ $rm }}" id="norm">
<script>
