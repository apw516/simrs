    ...
    <div class="card">
        <div class="card-header p-2">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a class="nav-link active" href="#timeline" data-toggle="tab">ASSESMEN AWAL MEDIS DAN
                        CPPT</a>
                </li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group mb-4" role="group" aria-label="Basic example">
                                                <button kodekunjungan="{{ $h->kode_kunjungan }}" type="button" class="btn btn-info lihathasillab" data-toggle="modal" data-target="#modalhasillab"><i class="bi bi-eye mr-1 ml-1"></i> Hasil Laboratorium</button>
                                                <button kodekunjungan="{{ $h->kode_kunjungan }}" type="button" class="btn btn-info lihathasilrad" data-toggle="modal" data-target="#modalhasilrad"><i class="bi bi-eye mr-1 ml-1"></i> Hasil Radiologi</button>
                                                <button kodekunjungan="{{ $h->kode_kunjungan }}" type="button" class="btn btn-info lihathasilpa" data-toggle="modal" data-target="#modalhasilpa"><i class="bi bi-eye mr-1 ml-1"></i> Hasil Laboratorium Patologi Anatomi</button>
                                            </div><br>
                                            <table class="table table-sm">
                                                <thead>
                                                    <th>Unit</th>
