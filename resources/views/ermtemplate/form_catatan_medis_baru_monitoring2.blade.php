                            ...
                            <div class="card-header" style="background-color: rgba(110, 245, 137, 0.745)"
                                ...
                                <h2 class="mb-0">
                                    <button class="btn btn-link btn-block text-left text-dark text-bold" type="button"
                                        ...
                                        aria-expanded="true" aria-controls="collapseOne">Nomor SEP :
                                        {{ $k->no_sep }} <br><br>
                                            ...
                                            <div class="card">
                                                ...
                                                @if ($k->id_1 != null)
                                                    <div class="container">
                                                        @if ($k->kode_unit != '1028')
                                                            <table class="table table-sm text-sm">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-bold font-italic">Frekuensi Nadi
                                                                    </td>
                                                                    <td>{{ $k->frekuensinadi }} x/menit</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="text-bold font-italic">Berat Badan /
                                                                        Tinggi Badan
                                                                        / IMT</td>
                                                                    <td colspan="3">{{ $k->beratbadan }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="text-bold font-italic">Frekuensi Nafas
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="4" class="bg-warning text-bold">
                                                                        Status
                                                                        Fungsional</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="text-bold font-italic">Penggunaan Alat
                                                                        Bantu</td>
                                                                    <td>{{ $k->penggunaanalatbantu }}</td>
                                                                    <td class="text-bold font-italic">Keterangan Alat
                                                                        Bantu</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $k->cacattubuh }}</td>
                                                                    <td class="text-bold font-italic">Keterangan Cacat
                                                                        Tubuh
                                                                    </td>
                                                        ...
                                                        <td>{{ $k->keterangancacattubuh }}</td>
                                                                ...
                                                                <tr>
                                                                    <td>3. Pasien dengan diagnosa khusus : Penyakit DM /
                                                                        Ginjal
                                                                        /
                                                                        Hati / Paru / Stroke / Kanker / Penurunan
                                                                        imunitas
                                                                        geriatri,
                                                                        lain lain...</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $k->tindakankeperawatan }}<br>
                                                                        <button
                                                                            class="btn btn-info riwayattindakan mt-4"
                                                        ...
                                                        @else
                                                            <div class="card mt-3">
                                                                <div class="card-header bg-success ">Hasil Pemeriksaan
                                                                </div>
                                                                <div class="card-body">
                                                                    {{ $k->tindakankeperawatan }}
                                                                    <br><br><button
                                                                        class="btn btn-info riwayattindakan_fisio"
                                                                        data-toggle="modal"
                                                                    ...
                                                                    <td>
                                                                        <div class="card">
                                                                            <table
                                                                                ...
                                                                                <tr>
                                                                                    <td>Pemeriksaan Fisik dan Uji Fungsi
                                                                                    </td>
                                                                                    <td>: {{ $k->pemeriksaan_fisik }}
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td>Suspek Penyakit akibat kerja
                                                                                    </td>
                                                                                    <td>: {{ $k->riwayatlain }}
                                                                                        <br>
                                                                                        ketereangan :
                                                                                ...
                                                                                <tr>
                                                                                    <td>Tindak Lanjut</td>
                                                                                    <td>
                                                                                        @foreach ($cek_iter as $it)
                                                                                            @if ($it->kode_kunjungan == $k->id_kunjungan)
                                                                                                PASIEN ITER jumlah iter
                                                                                                {{ $it->jumlah }} x
                                                                                                <br>
                                                                                            @endif
                                                                                        @endforeach
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3">
                                                                            ...
                                                                            @elseif ($k->tindak_lanjut == 2)
                                                                                Saat ini keadaan pasien dalam kondisi
                                                                                belum
