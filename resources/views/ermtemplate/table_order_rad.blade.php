<table id="table_order_rad" class="table table-sm table-bordered text-xs">
    <thead>
        <th>Kode Header</th>
        <th>Kode Detail</th>
        <th>Nama Layanan</th>
    ...
    <tbody>
        @foreach ($riwayat_tindakan_rad as $r)
...
<script>
    ...
    $('#table_order_rad').on('click', '.returheader', function() {
