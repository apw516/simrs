                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button tglkontrol="{{ $d->tglRencanaKontrol }}" jenissurat="{{ $d->jnsKontrol }}"
                            ...
                            kodedokter="{{ $d->kodeDokter }}" class="badge badge-warning editsurat"
                            data-toggle="modal" data-target="#modaleditsuratkontrol"><i
...
<script>
    ...
    $('#tabelsuratkontrol_peserta').on('click', '.hapussurat', function() {
    ...
    $('#tabelsuratkontrol_peserta').on('click', '.editsurat', function() {
