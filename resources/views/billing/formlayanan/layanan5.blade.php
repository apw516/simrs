<div class="form-row align-items-center">
  ...
  <div class="form-row align-items-center">
    <div class="col-sm-6 my-1">
      <label class="" for="">Nama layanan</label>
      <input type="text" class="form-control" placeholder="Ketik nama layanan" id="nl5" name="nl5">
      <input hidden type="text" class="form-control" placeholder="Ketik nama layanan" id="kodenl5" name="kodenl5">
    </div>
    <div class="col-sm-3 my-1">
      <label class="" for="">Tarif</label>
      <input readonly type="text" class="form-control" id="tl1" name="tl5">
    </div>
    <div class="col-sm-1 my-1">
      <label class="" for="inlineFormInputName">jlh</label>
      <input type="text" class="form-control" id="jlh5">
    </div>
    <div class="col-sm-1 my-1">
      <label class="" for="inlineFormInputName">disc</label>
      <input type="text" class="form-control" id="disc5">
    </div>
    <div class="col-sm-1 my-1">
      <label class="" for="inlineFormInputName">cyto</label>
      <input type="text" class="form-control" id="cyto5">
    </div>
  </div>
      <script>
        ...
        $(document).ready(function() {
                  $('#nl5').autocomplete({
                      ...
                      select: function(event, ui) {
                          $('[name="nl5"]').val(ui.item.label);
                          $('[name="kodenl5"]').val(ui.item.kode);
                          $('[name="tl5"]').val(ui.item.tarif);
                          $('[id="jlh5"]').val(1)
                    $('[id="disc5"]').val(0)
                    $('[id="cyto5"]').val(0)
                      }
