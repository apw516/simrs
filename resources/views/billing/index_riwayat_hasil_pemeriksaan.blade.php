...
@section('container')
                ...
                <div class="card card-outline card-primary shadow-sm">
                    <div class="card-header">
                        <h3 class="card-title font-weight-bold">
                            <i class="fas fa-filter mr-1"></i> Filter Periode Tanggal Entry Pemeriksaan
                        </h3>
                    </div>
                    <div class="card-body">
                        <form id="form-filter">
                            <div class="form-row align-items-end">
                                ...
                                <div class="form-group col-md-3 mb-0">
                                    <button type="button" class="btn btn-primary shadow-sm"
                                        onclick="caririwayatpemeriksaan()">
    ...
    <script>
        $(document).ready(function() {
            caririwayatpemeriksaan()
        });

        function caririwayatpemeriksaan() {
            spinner = $('#loader')
            spinner.show();
            ...
            $.ajax({
                ...
                url: '<?= route('cari_riwayat_hasil_pemeriksaan_pa') ?>',
