...
@section('container')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Data Expertisi Patologi Anatomi</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="card card-outline card-primary shadow-sm">
                    <div class="card-header">
                        <h3 class="card-title font-weight-bold">
                            <i class="fas fa-filter mr-1"></i> Filter Periode Tanggal Entry
                        </h3>
                    </div>
                    <div class="card-body">
                        <form id="form-filter">
    ...
    <script>
        ...
        function cariexpertisi() {
            ...
            $.ajax({
                ...
                url: '<?= route('cari_hasil_expertisi_pa') ?>',
