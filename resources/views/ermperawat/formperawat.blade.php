...
<div hidden class="v_utama">
    <div class="row mt-3">
                        ...
                        @endif --}}
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link" onclick="resume()">
                                    <i class="fas fa-filter mr-2"></i> Resume Perawat
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link" onclick="dataorderpenunjang()">
                                    <i class="fas fa-filter mr-2"></i> Data Order Penunjang
                                </a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="col-md-9">
            <button class="btn btn-warning mb-3 ambilberkasermpasien" data-toggle="modal"
                data-target="#modalberkaserm">
                <i class="bi bi-book mr-1 ml-1"></i> Catatan Medis Pasien</button>
            <button class="btn btn-success mb-3 lihaticare" data-toggle="modal" data-target="#modalicare">
                <i class="bi bi-book mr-1 ml-1"></i> Lihat Icare BPJS</button>
            <div class="slide3">
