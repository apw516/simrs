            ...
            <div class="modal-body">
                @if (count($hasil_ro_lama) > 0)
                    <table class="table table-sm">
                        ...
                        <tr>
                            <td>Hasil pemeriksaan lainnya</td>
                            <td colspan="3">
                                <textarea class="form-control" id="tekanan_intra_okular" name="tekanan_intra_okular">{{ $hasil_ro_lama[0]->tajampenglihatandekat }}</textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>Tekanan Intra Okular</td>
