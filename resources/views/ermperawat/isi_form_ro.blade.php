<div class="card">
    <div class="card-header bg-info">Pemeriksaan Khusus</div>
    <div class="card-body">
        @if(count($resume_perawat) > 0)
        @if(count($hasil_ro) == 0)
        <form action="" class="formro_mata">
            <input hidden type="text" class="form-control" name="idassesmen" id="idassesmen" value="{{ $resume_perawat[0]->id }}">
            <input hidden type="text" class="form-control" name="kodekunjungan" id="kodekunjungan" value="{{ $resume_perawat[0]->kode_kunjungan }}">
