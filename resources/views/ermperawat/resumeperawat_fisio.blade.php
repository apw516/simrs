                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {{-- <div class="card">
                                <div class="card-header text-bold text-lg"
                                    style="background-color: rgba(110, 245, 137, 0.745)"><i
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr class="bg-secondary">
                                                <td colspan="4" class="text-center text-bold font-italic">Metode Up
                                                    and Go</td>
                                            </tr>
                                            <tr>
                                                <td>Faktor Resiko</td>
                                            ...
                                            <tr>
                                                <td>a</td>
                                                <td>Perhatikan cara berjalan pasien saat akan duduk dikursi. Apakah
                                            ...
                                            <tr>
                                                <td>b</td>
                                                <td>Apakah pasien memegang pinggiran kursi atau meja atau benda lain
                                                    sebagai penopang saat akan
                                                    duduk ?</td>
                                            </tr>
                                            <tr class="bg-light">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="4"
                                                    class="text-center text-bold font-italic bg-secondary">Metode
                                                    Malnutrition
                                            ...
                                            <tr class="bg-light text-bold font-italic">
                                                <td colspan="4">2. Apakah asupan makanan berkurang karena
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td colspan="3" class="text-bold">
                                                {{ $r->diagnosakhusus }} <p class="float-right">
                                                    {{ $r->penyakitlainpasien }}
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="table">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        <tr>
                                            <td colspan="4" class="text-center bg-info">Diagnosa
                                                Keperawatan/Kebidanan</td>
                                        </tr>
                                        <tr>
                                            <td class="text-bold">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        <tr>
                                            <td colspan="4" class="text-center bg-info">Rencana
                                                Keperawatan/Kebidanan</td>
                                        </tr>
                                        <tr>
                                            <td class="text-bold">
                                        ...
                                        <tr>
                                            <td colspan="4" class="text-center bg-info">Tindakan
                                                Keperawatan/Kebidanan</td>
                                        </tr>
                                        <tr>
                                            <td class="text-bold">
                                        ...
                                        <tr>
                                            <td colspan="4" class="text-center bg-info">Evaluasi
                                                Keperawatan/Kebidanan</td>
                                        </tr>
                                        <tr>
                                            <td class="text-bold">
