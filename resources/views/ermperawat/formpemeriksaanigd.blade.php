            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <div class="form-check form-check-inline">
                            <textarea class="form-control" name="namakeluarga" id="namakeluarga"
                ...
                {{-- <tr>
                    ...
                    <td colspan="3">
                        <textarea class="form-control" id="keluhanutama" name="keluhanutama" placeholder="Subyektif anamnesis   ..."></textarea>
                    </td>
                </tr> --}}
            </table>
