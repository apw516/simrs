...
<body>
    <div class="isi-surat">
        <p class="float-right text-bold" style="margin-right:50px">RM.14-RI/Rev.02/19</p>
        <div class="container">
            ...
            <div class="isi-surat">
                <table class="mt-2 " style="border: 1px solid;width:100%">
                    <tbody>
                        ...
                        <tr>
                            <td style="text-align: center;height: 1px;" colspan="2" class="text-bold">KONSULTASI</td>
                ...
                <p style="text-align: right">Tanggal : {{ $cek[0]->tanggal_entry}}</p>
                <p style="text-align: left">Kepada Yth ... <br>
                Dokter Spesialis {{ $cek[0]->namaunittujuan}} <br>
                Mohon : <br>
                    <input type="checkbox" @if($cek[0]->konsul1 == 1) checked @endif readonly>
                    <label class="form-check-label" for="exampleCheck1">Konsul Untuk Kondisi  saat ini</label> <br>
                ...
                <table width="100%" class=" table-sm mt-2  text-bold font-italic">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">Salam Sejawat </td>
                    </tr>
                    <tr>
                        <td style="height: 130px;vertical-align: bottom;text-align:center">
                           </td>
                        <td style="height: 130px;vertical-align: bottom;text-align:center"> {{ $ts_kunjungan[0]->nama_dokter}}
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center"></td>
