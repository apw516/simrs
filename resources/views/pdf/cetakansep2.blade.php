...
<body>
    ...
    <table>
        <tr>
            <td><img src="{{ public_path('img/logobpjs.png') }}" style="height:40px; padding-right:0px;">
            </td>
            <td style="font-weight: bold;">SURAT ELIGIBILITAS PESERTA <br> RSUD WALED KABUPATEN.CIREBON</td>
    ...
    <table style="font-size:12px;">
        <tr>
            ...
            <td colspan="2" style="font-weight: bold;">: {{ strtoupper($sep->response->noSep) }}</td>
        </tr>
        <tr>
            <td>Tgl SEP</td>
    ...
    <table>
        <tr>
            ...
            <td style="font-size:8px">
                Persetujuan Pasien/Keluarga Pasien <br><img width="40%"
                    src="data:image/png;base64, {{ base64_encode(QrCode::generate($sep->response->peserta->noKartu)) }}"><br>Waktu:{{
                $now }}
            </td>
        </tr>
    </table>
