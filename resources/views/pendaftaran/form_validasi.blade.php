    ...
    <div class="card card-outline card-success">
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-7 mb-3">
                <input hidden type="text" value="{{ $kode_kunjungan }}" id="id_kodekunjungan">
                ...
                <div class="container mt-3">                    
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <select disabled readonly class="form-control" id="jenispelayanan" onchange="gantijenispelayanan()">
                    ...
                    <div id="formranap">
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <input type="checkbox" @if($crad == 1) checked @endif class="mr-1" value="1" id="naikkelas">Naik
                                            kelas
                                        </div>
                                    </div>
                        ...
                        <div @if($crad == 0) hidden @endif id="formnaikkelas" class="card-body bg-secondary">
                            <div class="row mt-2">
...
<div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog  modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Buat SPRI </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="exampleFormControlInput1">Tanggal SPRI</label>
                    <input type="email" class="form-control" id="tanggalkontrol"
                        placeholder="name@example.com" data-date-format="yyyy-mm-dd" value="{{ $tglmasuk }}">
                </div>
                <div class="form-group">
...
<script>
    ...
    function simpansep() {
        kode_kunjungan = $('#id_kodekunjungan').val();
