...
<div class="card shadow-sm border-0 mb-4">
    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center py-3"
        ...
        <div class="d-flex align-items-center">
            ...
            <span class="font-weight-bold"><i class="fas fa-id-card mr-2"></i>Detail Pasien Rawat Inap</span>
        </div>
                                    ...
                                    <tbody>
                                        @forelse($data_order as $index => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="text-bold text-dark">{{ $item->nama_barang ?? ($item->nama_barang ?? '-') }}</span>
                                                </td>
                                                <td class="text-center fw-bold">
                                                    {{ $item->jumlah_layanan ?? ($item->jumlah_layanan ?? 1) }}
                                                </td>
                                                <td class="text-end">
                                                    {{ $item->aturan_pakai }}
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    @if (($item->status_order ?? 0) == 2)
                                                        <span class="badge bg-success" style="font-size: 10px;">Sudah
                                                            dilayani</span>
                                                    @else
                                                        <span class="badge bg-warning text-dark"
                                                            style="font-size: 10px;">Belum dilayani</span>
                                                    @endif
                                                </td>
                                            </tr>
                                        @empty
                ...
                <tbody id="wrapper-obat-terpilih">
                    @forelse($data_order as $index => $item)
                        <tr id="row-obat-${kodeBarang}">
                            ...
                            <td>
                                <span class="font-weight-bold d-block">{{ $item->nama_barang }}</span>
                            ...
                            <td hidden>
                                <input type="number" name="jlh_iterasi"
                                    class="form-control form-control-sm text-center" value="0" min="0">
                            </td>
                            <td>
                                <div class="row">
                                    <div class="col-md-6"><input hidden type="number" name="jumlahhari"
                            ...
                            <td hidden>
                                <input hidden type="number" name="jumlahobat"
                                    class="form-control form-control-sm text-center input-jumlah-obat" value="1"
                                    min="1" max="${maxStok}" required>
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="number" name="signa2" class="form-control form-control-sm text-center"
