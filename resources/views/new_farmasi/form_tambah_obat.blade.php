            ...
            <div class="row">
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <input type="date" name="tgl_resep" class="form-control" placeholder="0" min="1"
                        value="@if($resep_bpjs_header){{ $resep_bpjs_header[0]->tglpelrsp }}@else{{ request('tgl_awal', date('Y-m-d')) }}@endif">
                </div>
                <div class="col-md-2 mb-3">
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <select class="form-control" id="iterasi" name="iterasi">
                        <option value="0" @if($resep_bpjs_header) @if($resep_bpjs_header[0]->iterasi == 0) selected @endif @endif>NON - ITERASI</option>
                        <option value="1" @if($resep_bpjs_header) @if($resep_bpjs_header[0]->iterasi == 1) selected @endif @endif>ITERASI 1 X</option>
                        <option value="2" @if($resep_bpjs_header) @if($resep_bpjs_header[0]->iterasi == 2) selected @endif @endif>ITERASI 2 X</option>
                    </select>
                </div>
                <div class="col-md-2 mb-3">
                    <label class="font-weight-bold small text-muted">Jenis Obat</label>
                    <select class="form-control" id="jenisobat" name="jenisobat">
                        <option value="0" @if($resep_bpjs_header) @if($resep_bpjs_header[0]->KDJNSOBAT == 0) selected @endif @endif>Obat Reguler</option>
                        <option value="1" @if($resep_bpjs_header) @if($resep_bpjs_header[0]->KDJNSOBAT == 1) selected @endif @endif>Obat PRB</option>
                        <option value="2" @if($resep_bpjs_header) @if($resep_bpjs_header[0]->KDJNSOBAT == 2) selected @endif @endif>Obat Kronis</option>
                        <option value="3" @if($resep_bpjs_header) @if($resep_bpjs_header[0]->KDJNSOBAT == 3) selected @endif @endif>Obat Kemo</option>
                    </select>
                </div>
                ...
                <div class="col-md-3 mb-3">
                    <label class="font-weight-bold small text-muted">No SEP Apotek</label>
                    <input readonly type="text" name="no_sep_apotek" class="form-control" placeholder="0" min="1"
                        value="@if($resep_bpjs_header){{ $resep_bpjs_header[0]->Sepapotek}}@else 0 @endif">
                </div>
                <div class="col-md-4 mb-3">
                    <label class="font-weight-bold small text-muted">Kode Layanan Header</label>
                    <input readonly type="text" name="kode_layanan_header" class="form-control" placeholder="0" min="1"
                        value="{{ $ts_layanan_header[0]->kode_layanan_header}}">
                    <input hidden readonly type="text" name="id_layanan_header" class="form-control" placeholder="0" min="1"
                        value="{{ $ts_layanan_header[0]->id}}">
                </div>
            </div>
            <div class="row">
