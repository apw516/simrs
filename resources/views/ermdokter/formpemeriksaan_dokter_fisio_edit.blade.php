<div class="card">
    ...
    <div class="card-body">
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Frekuensi Nafas Pasien ..."
                                        ...
                                        aria-describedby="basic-addon2" value="{{ $last_assdok[0]->frekuensi_nafas }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text" id="basic-addon2">x/menit</span>
                                    </div>
                                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <textarea type="text" class="form-control" id="keterangantindaklanjut" name="keterangantindaklanjut"
                            aria-describedby="emailHelp">{{ $resume_now[0]->keterangan_tindak_lanjut }}</textarea>
                    </div>
                </div>
            </div>
        </form>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="card">
                    <div class="card-header bg-dark">Riwayat Order Order Hari Ini</div>
                    <div class="card-body">
                        <div class="vrorder">
