                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <textarea class="form-control" rows="8" id="hasilpemeriksaanro" name="hasilpemeriksaanro">
                                                        @if (count($hasil_ro) > 0){{ $hasil_ro[0]->tajampenglihatandekat }}@endif
                                                    </textarea>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card-body">
                                                    <table class="table table-sm">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3"><input class="form-control"
                                                                    value="" name="kiri_bilik_mata_depan"
