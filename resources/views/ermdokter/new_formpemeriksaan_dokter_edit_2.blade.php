                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text"
                                                                value="{{ $k1[0]->refraktometer_od_cyl }}"
