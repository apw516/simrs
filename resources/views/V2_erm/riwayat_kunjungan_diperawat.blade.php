                                        ...
                                        @else
                                         <table class="table table-sm">
                                             ...
                                             <tr>
                                                 ...
                                                 <td class="font-italic" colspan="5">: {{ $a->rencanakeperawatan }}
                                                 </td>
                                             </tr>
                                             <tr>
                                     ...
                                     <div class="timeline-body">
                                         @if ($k->kode_unit == '1028')
                                             <table class="table table-sm table-bordered">
                                                 <tbody>
                                                     <tr>
                                                         <td colspan="6" class="text-bold text-center">Tanda tanda
                                                             vital</td>
                                                     </tr>
                                                     <tr>
                                                         <td width="15%" class="text-bold">Tekanan Darah</td>
                                                         <td width="15%" class="font-italic">:
                                                             {{ $a->tekanan_darah }} mmHg
                                                         </td>
                                                         <td width="15%" class="text-bold">Frekuensi Nadi</td>
                                                         <td class="font-italic">: {{ $a->frekuensi_nadi }} x/menit
                                                         </td>
                                                         <td width="15%" class="text-bold">Frekuensi Nafas</td>
                                                         <td class="font-italic">: {{ $a->frekuensi_nafas }} x/menit
                                                         </td>
                                                     </tr>
                                                     <tr>
                                                         <td width="15%" class="text-bold">Suhu</td>
                                                     ...
                                                     <tr>
                                                         <td colspan="6" class="text-bold text-center">Layanan fisik
                                                             dan rehabilitasi</td>
                                                     </tr>
                                                     <tr>
                                                         <td>Anamanesa</td>
