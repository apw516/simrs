<table id="tabelkomponenobat" class="table table-sm text-xs table-bordered table-hover">
    <thead>
        <th>Nama Obat</th>
        <th>Nama Generik</th>
        <th>Dosis</th>
    ...
    <tbody>
        @foreach ($obat as $o)
            <tr class="pilihobatkomponen" sediaan="{{ $o->sediaan}}" kode_barang="{{ $o->kode_barang }}" nama_barang="{{ $o->nama_barang }}"
