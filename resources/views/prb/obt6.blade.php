    ...
    <div class="card-body">
        ...
        <div class="row mt-2 dokterlayan">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <div class="col">
                      <input type="text" id="namaobat6" class="form-control" placeholder="nama obat ..">
                      <input hidden type="text" id="kodeobat6" class="form-control" placeholder="">
                    </div>
                    <div class="col">
                        <select id="signa1_6" class="form-control">
                            <option value="1">Signa 1</option>
                            <option value="2">Signa 2</option>
                        </select>
                    </div>
                    <div class="col">
                        <select id="signa2_6" class="form-control">
                            <option value="1">Signa 1</option>
                            <option value="2">Signa 2</option>
                        </select>
                    </div>
                    <div class="col">
                      <input type="text" id="jmlhobt6" class="form-control" placeholder="jumlah obat..">
                    </div>
                  </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function() {
           $('#namaobat6').autocomplete({
               source: "<?= route('cariobat') ?>",
               select: function(event, ui) {
                   $('[id="namaobat6"]').val(ui.item.label);
                   $('[id="kodeobat6"]').val(ui.item.kode);
               }
           });
       });
</script>