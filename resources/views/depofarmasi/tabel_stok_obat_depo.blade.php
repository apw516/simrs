...
<script>
    ...
    $(".pilihobat").on('click', function(event) {
        ...
        $(wrapper).append(
            ...
            sediaan +
            '"></div><div class="form-group col-md-3"><label for="">Aturan Pakai / Keterangan</label><textarea type="" cols="3" rows="3" class="form-control form-control-sm text-xs edit_field" id="aturanpakai" name="aturanpakai" value="">' +
            aturanpakai +
